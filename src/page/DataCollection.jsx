...
const DataCollectionSection = () => {
  ...
  return (
    <section id="data-collection" className="py-24 bg-white border-b border-gray-100">
        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          >
            <img 
              ...
              alt="Digital data collection and management in the field"
          ...
          >
            ...
            <p className="md:text-2xl text-xl text-[#F47B20] font-medium leading-tight mb-8">
              Collect better data. Manage it effectively.
            </p>

            <p className="md:text-lg text-sm text-[#0b0b5c] leading-relaxed mb-12">
              We deploy modern digital systems and data management solutions that improve data accuracy, 
              timeliness, accessibility, and usability. We help organisations move from traditional 
              and fragmented data processes to efficient, technology-driven systems.
            </p>
